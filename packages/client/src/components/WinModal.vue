...
import { textColorClasses } from '../constants/colors'
...
<template>
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="mx-4 max-w-sm w-full rounded-lg bg-[#121212] text-[#e5e7eb] p-6 shadow-lg">
      ...
      <button class="btn rounded bg-[#2563eb] px-4 py-2 text-white" @click="props.onClose">
        Play Again
      </button>
    </div>
  </div>
